...
export default function AiChatAssistant({ isOpen, setIsOpen, settings }: AiChatAssistantProps) {
  ...
  const [messages, setMessages] = useState<Array<{ role: 'user' | 'model', text: string }>>([
    {
      role: 'model',
      text: 'مرحباً بك يا صديقي وشريكي في العمل! 👋\nأنا مستشارك الميداني الحريص على نجاحك، ومستعد لمساعدتك كتفاً بكتف في كل خطوة بالسوق. سدّد الله خطاك، كيف يمكننا تحقيق مبيعات ناجحة وتجاوز الصعاب معاً اليوم؟'
    }
  ]);
