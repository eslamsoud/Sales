...
أريد فقط نص الرسالة بدون أي مقدمات أخرى لتكون جاهزة للإرسال مباشرة للعميل وبصيغة جذابة.`;
  ...
  React.useEffect(() => {
    ...
    const initMap = async () => {
      ...
      // Enable manual map click to instantly reposition both marker and circle
      ...
      // Also support clicking inside the circle to move the center
  ...
  const getAIAdviceForStore = (type: string) => {
    ...
    if (t.includes('هايبر ماركت') || t.includes('سوبر ماركت كبير')) {
      return {
        ...
        bestPractice: 'الهايبر ماركت يتميز بحجم مسحوبات ضخم جداً ونقاط ترويج قوية. ركز على تقديم عروض أسعار الكرتونة والجملة الحصرية مع تسهيلات سداد وعرض ترويجي بارز وستاند عرض خاص بمنتجاتنا مجاناً لزيادة التفاعل اليومي ورؤية المنتج.',
        steps: [
          'الاتفاق مع الإدارة على وضع ستاند عرض خشبي مخصص لمنتجاتنا مجاناً.',
      ...
      return {
        ...
        bestPractice: 'الأفران والمخابز تستهلك كميات وفيرة من السمن الصناعي والزبدة وزيوت العجن لدعم جودة العجين. اعرض عليهم صفائح الزيت والسمن الخاصة بنا بأوزانها وسعر الجملة للمخابز مع التركيز على نعومة الملمس والتوراق وجودة رائحة المخبوزات والكرواسون.',
        steps: [
      ...
      return {
        ...
        bestPractice: 'الاعتماد على عينات مجانية صغيرة الحجم لعرض جودة المنتج لربات البيوت. قدم له ميزة الدفع الآجل الجزئي بعد سحب الدفعة الأولى. ركز على أن منتجاتنا تحقق هامش ربح أعلى 15% مقارنة بالمنتجات المنافسة مع جودة تضاهي الشركات الكبرى.',
        steps: [
      ...
      return {
        ...
        bestPractice: 'المطاعم تستهلك كميات ضخمة من الزيوت والسمن ويبحثون بالدرجة الأولى عن نقطة الدخان المرتفعة ومقاومة الزرنخة وقدرة التحمل بالتسخين المديد. ركز أثناء حديثك على نقاء زيوتنا وسعة توفيرها في القلي المتكرر دون تغير الطعم.',
        steps: [
  ...
  const generateAIPitchMessage = (type: string, clientName: string) => {
    ...
    if (t.includes('هايبر ماركت') || t.includes('سوبر ماركت كبير')) {
      return `السلام عليكم يا فندم، معكم مندوب مبيعات منتجاتنا الفاخرة 🌸. يسعدنا التعاون معكم وتقديم عروض سمن وزيوت حصرية لـ [ ${clientName} ] بمميزات مخصصة للهايبر ماركت وسحب كميات ومستويات توريد مستمرة. نضمن لكم هامش ربح ممتاز وتجربة عينات مجانية لعملائكم.${guidelines}\n\nهل نتشرف بتحديد موعد للزيارة؟`;
    } else if (t.includes('مخبز') || t.includes('أفران') || t.includes('فرن')) {
      return `السلام عليكم ورحمة الله، معكم مندوب مبيعات منتجاتنا الخاصة بالمعجنات 🥖. يشرفنا تزويد [ ${clientName} ] بأجود أنواع سمن العجن والزيوت النباتية المصفاة المخصصة للحلويات والفينو والمعجنات، بأسعار جملة تشجيعية وتسهيل دفع ممتاز لضمان جودة طعم ورائحة لا تقاوم لمخبوزاتكم.${guidelines}\n\nيسعدنا إرسال عينة تجريبية للمصانع والأفران اليوم للتجربة الفوقية؟`;
    } else if (t.includes('سوبر ماركت') || t.includes('هايبر')) {
      return `السلام عليكم يا فندم، معكم مندوب مبيعات منتجاتنا الفاخرة 🌸. يسعدنا التعاون معكم وتقديم عرض توريد خاص جداً يناسب السوبر ماركت المميز لديكم [ ${clientName} ] بمستويات طلب مرنة وهوامش ربح ممتازة لعملائكم، مع توفير عينات تذوق مجاناً لزيادة حركة سحب الصنف بالرفوف.${guidelines}\n\nهل يمكننا تحديد موعد لزيارتكم وتقديم قائمة الأسعار والخصومات الحصرية؟`;
    } else if (t.includes('بقالة') || t.includes('مواد غذائية')) {
      return `أهلاً بحضرتك يا فندم، معكم مندوب مبيعات منتجاتنا الفاخرة 🌟. يسعدنا نوفر لكم خدمة توصيل سريعة ومجانية لبقالتكم الكريمة [ ${clientName} ] مع هامش ربح تنافسي يزيد مبيعاتكم، وضمان الاسترجاع الكامل والاستبدال الفوري للأصناف. أسعارنا تبدأ من كرتونة واحدة وتسهيلات دفع تشجيعية.${guidelines}\n\nيشرفنا نرسل لحضرتك كتالوج الأصناف المتاحة للطلب الفوري؟`;
    } else if (t.includes('مطعم')) {
      return `السلام عليكم يا فندم، معكم شريككم في الجودة؛ منتجاتنا الممتازة للمطاعم الفاخرة [ ${clientName} ] 🍳. ندرك أهمية نقاوة الزيت ومقاومته للحرارة العالية لتقديم طعام صحي وشهي؛ لذلك صممنا عروض الجملة الخاصة بمطاعم الفول والفلافل والمأكولات الشعبية بنسب توفير مذهلة وبند سحب دوري سهل.${guidelines}\n\nيسعدنا إرسال عينة تذوق وتجريب مجانية للمطبخ اليوم للتأكد من جدارتنا بالاعتماد؟`;
    } else {
      return `مرحباً بحضرتك يا فندم، معكم منتجاتنا الفاخرة 🌿. نتشرف بالتعاون مع تجار العطارة الكرام في [ ${clientName} ]، ونوفر لكم سمن بلدي وزيوت طبيعية بنكهات أصلية وروائح جذابة تضمن ولاء المتسوقين وبخصومات مخصصة للكميات تبدأ من 5 كراتين مع ترويج مجاني لعطارتكم في منصاتنا لضمان بيع ممتاز.${guidelines}\n\nهل تود التعرف على أسعار التوريد والكميات المتاحة حالياً؟`;
    }
  };
                              ...
                              {activePitchLeadId === lead.id && (
                                <div className="bg-indigo-50/60 border border-indigo-200 p-3.5 rounded-xl flex flex-col gap-2.5 animate-fade-in text-xs mt-1">
                                  <span className="font-black text-indigo-950 flex items-center gap-1 bg-[#FFFFFF]/80 py-1 px-2.5 rounded-md border border-indigo-100 w-max mb-1">
                                    ...
                                    مسودة العرض الذكية المجهزة من الذكاء الاصطناعي:
                                  </span>
                                  <textarea
                                    value={aiPitchText}
