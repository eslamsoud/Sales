          ...
          <div className="bg-[#FFFFFF] rounded-3xl w-full max-w-sm overflow-hidden shadow-2xl flex flex-col max-h-[85vh] animate-in zoom-in-95 duration-200">
            ...
            <div className="p-4 border-t border-slate-100 bg-[#F7FAFC] flex flex-col gap-2">
              ...
              <button
                ...
                className="bg-indigo-600 hover:bg-indigo-700 text-white font-extrabold py-2.5 rounded-xl text-xs transition-colors flex items-center justify-center gap-1.5 cursor-pointer shadow-sm active:scale-95 border-none"
              >
          ...
          <div className="bg-[#FFFFFF] rounded-2xl border border-slate-100 shadow-xl max-w-sm w-full p-6 text-center flex flex-col gap-4 animate-scale-up">
            ...
            <div className="flex flex-col gap-2">
              <button
                ...
                className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-extrabold py-3 rounded-xl text-xs transition-all flex items-center justify-center gap-1.5 cursor-pointer shadow-md active:scale-95 border-none"
              >
                <Printer className="h-4 w-4" />
