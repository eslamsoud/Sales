...
import { Receipt, Plus, Trash2, ArrowRight, Save, User, MapPin, Percent, HelpCircle, Package, AlertTriangle, Scale, Eye, Search, Check, Loader2, Download, Share2, FileText } from 'lucide-react';
          ...
          <div className="bg-[#FFFFFF] rounded-3xl w-full max-w-sm overflow-hidden shadow-2xl flex flex-col max-h-[85vh] animate-in zoom-in-95 duration-200">
            ...
            <div className="p-4 border-t border-slate-100 bg-[#F7FAFC] flex flex-col gap-2">
              ...
              <button
                ...
                className="bg-indigo-100 hover:bg-indigo-200 text-indigo-800 font-bold py-2.5 rounded-xl text-xs transition-colors flex items-center justify-center gap-1.5 cursor-pointer shadow-sm active:scale-95"
              >
                <FileText className="h-4 w-4" />
                تنزيل كملف PDF للطباعة
              </button>
            </div>
          </div>
        </div>
